...
while keyboard.is_pressed('.') == False:
    ...
    for pos in locations:
        ...
        print(a,b,c,d)
    locations = pyautogui.locateAll('Visual Memory\size2.png', pic)
    for pos in locations:
        a,b,c,d = pos
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    locations = pyautogui.locateAll('Visual Memory\size3.png', pic)
    for pos in locations:
        a,b,c,d = pos
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    locations = pyautogui.locateAll('Visual Memory\size4.png', pic)
    for pos in locations:
        a,b,c,d = pos
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    locations = pyautogui.locateAll('Visual Memory\size5.png', pic)
    for pos in locations:
        a,b,c,d = pos
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    locations = pyautogui.locateAll('Visual Memory\size6.png', pic)
    for pos in locations:
        a,b,c,d = pos
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    locations = pyautogui.locateAll('Visual Memory\size7.png', pic)
    for pos in locations:
        a,b,c,d = pos
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    locations = pyautogui.locateAll('Visual Memory\size8.png', pic)
    for pos in locations:
        a,b,c,d = pos
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    locations = pyautogui.locateAll('Visual Memory\size9.png', pic)
    for pos in locations:
        a,b,c,d = pos
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    ...
    for pos in locations:
        ...
        click(a+c/2+x1,b+d/2+y1)
        print(a,b,c,d)
    #locations = pyautogui.locateAll('Visual Memory\size11.png', pic)
    #for pos in locations:
        #a,b,c,d = pos
        #click(a+c/2+x1,b+d/2+y1)
        #print(a,b,c,d)
